...
Для того чтобы сыграть в данную игру Вам необходимо заменить все пути к папкам в коде на свои.

Игра оптимизирована для "Командной строки". Чтобы запустить ее в командной строке необходимо ввести:
python полный пусть к файлу\Vicelisa.py (Должна быть установлена оболчка Python).
